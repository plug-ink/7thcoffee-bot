...
### Бариста
![Панель баристы: поиск по 4 цифрам номера и карточка клиента](screenshots/barista-card-search.png)  
*Бариста вводит 4 цифры номера → видит карточку клиента и кнопку «Начислить».*

### Админ-панель
![Админ-панель: главное меню и переключение ролей](screenshots/admin-main-options.png)  
