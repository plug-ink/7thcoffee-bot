...
Клиент берёт напиток, показывает свой QR или называет последние 4 цифры номера телефона — бариста находит карточку клиента и "ставит штамп". Бот сохраняет. На 7-й покупке подарок
